      ...
      <Container className="py-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-2 xl:grid-cols-12">
          ...
          <div className="xl:col-span-5">
            ...
            <p className="text-small mt-6 max-w-sm leading-relaxed opacity-70">
            ...
            <a
              ...
              className="text-small mt-6 inline-flex items-center gap-2 opacity-70 transition-opacity hover:opacity-100"
            >
          ...
          <nav aria-label="Soluzioni" className="xl:col-span-3">
            <h2 className="text-small mb-5 font-semibold uppercase tracking-[0.2em] opacity-50">
              Soluzioni
            </h2>
