...
export default function VoipWaveform({ className, forceInvert, animate = true }: { className?: string, forceInvert?: boolean, animate?: boolean }) {
    ...
    const shouldAnimate = animate && isIntersecting
        ...
        return (
                ...
                .bar-animated {
                    ...
                    ${shouldAnimate ? 'animation: waveGrow 3.5s ease-in-out infinite;' : ''}
                }
            `}</style>
                                        ...
                                        {bars.map((bar, idx) => {
                                                const rect = (
                                                        <rect
                                                                ...
                                                                height={bar.h}
                                                                rx="3"
                                                                fill={forceInvert ? "currentColor" : "#566156"}
                                                                className={cn(shouldAnimate && "bar-animated")}
